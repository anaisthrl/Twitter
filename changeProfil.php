...
<article>
    ...
    <form method="post" action="traitementChangeProfil.php">
        ...
        <p>
            ...
            <input type="text" name="pseudo" id="pseudo" class="field-divided" placeholder="Pseudo" size="30" maxlength="10" />

            <input type="text" name="info_perso" id="info_perso" class="field-divided" placeholder="bio de l'utilisateur" size="30"/><br/>

            <label for="birth">Votre date de naissance<br/></label>

            <input type="date" name="birth" id="birth" class="field-divided" placeholder="date de naissance"/>
